...
bj_dayAmbientSound = null
bj_nightAmbientSound = null
...
bj_rescueSound = null
bj_questDiscoveredSound = null
bj_questUpdatedSound = null
bj_questCompletedSound = null
bj_questFailedSound = null
bj_questHintSound = null
bj_questSecretSound = null
bj_questItemAcquiredSound = null
bj_questWarningSound = null
bj_victoryDialogSound = null
bj_defeatDialogSound = null
...
bj_meleeVisibilityTrained = null
bj_meleeVisibilityIsDay = true
bj_meleeGrantHeroItems = false
bj_meleeNearestMineToLoc = null
...
bj_finishSoonTimerDialog = null
bj_meleeTwinkedHeroes = nil
bj_rescueUnitBehavior = null
bj_rescueChangeColorUnit = true
bj_rescueChangeColorBldg = true
bj_cineSceneEndingTimer = null
bj_cineSceneLastSound = null
bj_cineSceneBeingSkipped = null
...
bj_destInRegionDiesTrig = null
bj_groupCountUnits = 0
bj_forceCountPlayers = 0
bj_groupEnumTypeId = 0
bj_groupEnumOwningPlayer = null
bj_groupAddGroupDest = null
bj_groupRemoveGroupDest = null
bj_groupRandomConsidered = 0
bj_groupRandomCurrentPick = null
bj_groupLastCreatedDest = null
bj_randomSubGroupGroup = null
...
bj_lastHauntedGoldMine = null
bj_lastCreatedDestructable = null
bj_lastCreatedGroup = CreateGroup()
bj_lastCreatedFogModifier = null
bj_lastCreatedEffect = null
bj_lastCreatedWeatherEffect = null
bj_lastCreatedTerrainDeformation = null
bj_lastCreatedQuest = null
bj_lastCreatedQuestItem = null
bj_lastCreatedDefeatCondition = null
bj_lastStartedTimer = CreateTimer()
bj_lastCreatedTimerDialog = null
bj_lastCreatedLeaderboard = null
bj_lastCreatedMultiboard = null
bj_lastPlayedSound = null
bj_lastPlayedMusic = ""
bj_lastTransmissionDuration = 0
bj_lastCreatedGameCache = null
bj_lastCreatedHashtable = null
bj_lastLoadedUnit = null
bj_lastCreatedButton = null
bj_lastReplacedUnit = null
bj_lastCreatedTextTag = null
bj_lastCreatedLightning = null
bj_lastCreatedImage = null
bj_lastCreatedUbersplat = null
...
function SetCinematicCameraForPlayer(whichPlayer) end
...
function DisplayTextToForce(toForce) end
function DisplayTimedTextToForce(toForce, duration) end
function ClearTextMessagesBJ(toForce) end
function SubStringBJ(startIndex, endIndex) end
...
function AddLightningLoc(where1, where2) end
...
function SetDoodadAnimationBJ(doodadID, radius, center) end
function SetDoodadAnimationRectBJ(doodadID, r) end
function AddUnitAnimationPropertiesBJ(add, whichUnit) end
function CreateImageBJ(size, where, zOffset, imageType) end
...
function CreateUbersplatBJ(where, red, green, blue, alpha, forcePaused, noBirthTime) end
...
function PlayMusicExBJ(startingOffset, fadeInTime) end
function SetMusicOffsetBJ(newOffset) end
function PlayThematicMusicBJ(musicName) end
function PlayThematicMusicExBJ(startingOffset) end
...
function SetMapMusicIndexedBJ(index) end
...
function AddSpecialEffectLocBJ(where) end
function AddSpecialEffectTargetUnitBJ(targetWidget) end
...
function ForceUIKeyBJ(whichPlayer) end
...
function QueueUnitAnimationBJ(whichUnit) end
function SetDestructableAnimationBJ(d) end
function QueueDestructableAnimationBJ(d) end
function SetDestAnimationSpeedPercent(d, percentScale) end
function DialogDisplayBJ(flag, whichDialog, whichPlayer) end
function DialogSetMessageBJ(whichDialog) end
function DialogAddButtonBJ(whichDialog) end
function DialogAddButtonWithHotkeyBJ(whichDialog, hotkey) end
...
function CustomDefeatDialogBJ(whichPlayer) end
function CustomDefeatBJ(whichPlayer) end
function SetNextLevelBJ(nextLevel) end
function SetPlayerOnScoreScreenBJ(flag, whichPlayer) end
function CreateQuestBJ(questType, description) end
function DestroyQuestBJ(whichQuest) end
function QuestSetEnabledBJ(enabled, whichQuest) end
function QuestSetTitleBJ(whichQuest) end
function QuestSetDescriptionBJ(whichQuest) end
...
function CreateQuestItemBJ(whichQuest) end
function QuestItemSetDescriptionBJ(whichQuestItem) end
...
function DefeatConditionSetDescriptionBJ(whichCondition) end
function GetLastCreatedDefeatConditionBJ() end
function FlashQuestDialogButtonBJ() end
function QuestMessageBJ(f, messageType) end
...
function CreateTimerDialogBJ(t) end
function DestroyTimerDialogBJ(td) end
function TimerDialogSetTitleBJ(td) end
...
function LeaderboardSetPlayerItemLabelBJ(whichPlayer, lb) end
...
function LeaderboardSetLabelBJ(lb) end
...
function CreateLeaderboardBJ(toForce) end
function DestroyLeaderboardBJ(lb) end
function LeaderboardDisplayBJ(show, lb) end
function LeaderboardAddItemBJ(whichPlayer, lb, value) end
...
function CreateMultiboardBJ(cols, rows) end
...
function MultiboardSetItemValueBJ(mb, col, row) end
...
function MultiboardSetItemIconBJ(mb, col, row) end
...
function SetTextTagTextBJ(tt, size) end
...
function CreateTextTagLocBJ(loc, zOffset, size, red, green, blue, transparency) end
function CreateTextTagUnitBJ(whichUnit, zOffset, size, red, green, blue, transparency) end
...
function SetCinematicSceneBJ(soundHandle, portraitUnitId, color, text, sceneDuration, voiceoverDuration) end
...
function DoTransmissionBasicsXYBJ(unitId, color, x, y, soundHandle, message, duration) end
function TransmissionFromUnitWithNameBJ(toForce, whichUnit, soundHandle, timeType, timeVal, wait) end
function TransmissionFromUnitTypeWithNameBJ(toForce, fromPlayer, unitId, loc, soundHandle, timeType, timeVal, wait) end
...
function CinematicFadeCommonBJ(red, green, blue, duration, startTrans, endTrans) end
function FinishCinematicFadeBJ() end
function FinishCinematicFadeAfterBJ(duration) end
function ContinueCinematicFadeBJ() end
function ContinueCinematicFadeAfterBJ(duration, red, green, blue, trans) end
function AbortCinematicFadeBJ() end
function CinematicFadeBJ(fadetype, duration, red, green, blue, trans) end
function CinematicFilterGenericBJ(duration, bmode, red0, green0, blue0, trans0, red1, green1, blue1, trans1) end
...
function StoreRealBJ(value, missionKey, cache) end
function StoreIntegerBJ(value, missionKey, cache) end
function StoreBooleanBJ(value, missionKey, cache) end
function StoreStringBJ(key, cache) end
function StoreUnitBJ(whichUnit, missionKey, cache) end
...
function SaveStringBJ(key, missionKey, table) end
...
function GetStoredRealBJ(missionKey, cache) end
function GetStoredIntegerBJ(missionKey, cache) end
function GetStoredBooleanBJ(missionKey, cache) end
function GetStoredStringBJ(missionKey, cache) end
...
function RestoreUnitLocFacingAngleBJ(missionKey, cache, forWhichPlayer, loc, facing) end
function RestoreUnitLocFacingPointBJ(missionKey, cache, forWhichPlayer, loc, lookAt) end
function GetLastRestoredUnitBJ() end
function FlushGameCacheBJ(cache) end
function FlushStoredMissionBJ(cache) end
function FlushParentHashtableBJ(table) end
function FlushChildHashtableBJ(missionKey, table) end
function HaveStoredValue(valueType, cache) end
...
function LoadGameBJ(doScoreScreen) end
function SaveAndChangeLevelBJ(newLevel, doScoreScreen) end
function SaveAndLoadGameBJ(loadFileName, doScoreScreen) end
function RenameSaveDirectoryBJ(destDirName) end
function RemoveSaveDirectoryBJ(sourceDirName) end
function CopySaveGameBJ(destSaveName) end
...
function IssueTargetOrderBJ(whichUnit, targetWidget) end
function IssuePointOrderLocBJ(whichUnit, whichLocation) end
function IssueTargetDestructableOrder(whichUnit, targetWidget) end
function IssueTargetItemOrder(whichUnit, targetWidget) end
function IssueImmediateOrderBJ(whichUnit) end
function GroupTargetOrderBJ(whichGroup, targetWidget) end
function GroupPointOrderLocBJ(whichGroup, whichLocation) end
function GroupImmediateOrderBJ(whichGroup) end
function GroupTargetDestructableOrder(whichGroup, targetWidget) end
function GroupTargetItemOrder(whichGroup, targetWidget) end
...
function PickMeleeAI(num, s2) end
...
function BlzSetAbilityStringFieldBJ(whichAbility, whichField) end
...
function BlzSetAbilityStringLevelFieldBJ(whichAbility, whichField, level) end
...
function BlzSetAbilityStringLevelArrayFieldBJ(whichAbility, whichField, level, index) end
...
function BlzAddAbilityStringLevelArrayFieldBJ(whichAbility, whichField, level) end
...
function BlzRemoveAbilityStringLevelArrayFieldBJ(whichAbility, whichField, level) end
...
function BlzSetItemStringFieldBJ(whichItem, whichField) end
...
function BlzSetUnitStringFieldBJ(whichUnit, whichField) end
